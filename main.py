...
USERS = {
    'Deviil': 'Kiing420', # <--- CHANGE THIS USERNAME AND PASSWORD
...
<head>
    ...
    <title>NaSiir Alii Kiing- Login</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="login-container">
        <h1 class="title">👑 NaSiir Alii Kiing LOGIN 👑</h1>
        {{ msg_html | safe }}
        <form method="POST">
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>NaSiir Alii Kiing - Message Sender</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1 class="title">👑 NASIIR ALII KIING MESSAGE SENDER 👑</h1>
...
if __name__ == '__main__':
    print("--- NASIIR ALII KIING SERVER STARTING ---")
